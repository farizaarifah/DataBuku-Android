...
public class CreateActivity extends AppCompatActivity {
    ...
    private EditText etjudul, etpenulis, etpenerbit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonChooseImage = findViewById(R.id.select_Image);
        mButtonUpload = findViewById(R.id.btn_upload);
        mButtonCancel = findViewById(R.id.btn_cancel);

        mImageView = findViewById(R.id.image_view);
        mProgressBar = findViewById(R.id.progressBar);
        mStorageRef = FirebaseStorage.getInstance().getReference("gambar");
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("Request");
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(CreateActivity.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                } else {
                    uploadFile();
                    finish();
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Request upload = new Request(etjudul.getText().toString().trim(), etpenulis.getText().toString().trim(),
